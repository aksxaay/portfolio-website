...
function Clients() {
  return (
    <section className="container mt-32 flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full">
			<section className="w-full">
				<h2 id="clients" className="secondary-title">Clients</h2>
				<p className="section-paragraph">I’ve also explored various options, which include free-lancing to meet the client's need(s)</p>
				{/* <!-- Clients --> */}
				<div className="space-y-12">
					<div className="w-full border border-nav p-16 lg:px-32 lg:py-20 lg:space-x-32 flex justify-center lg:justify-start flex-wrap lg:flex-nowrap rounded-lg">
